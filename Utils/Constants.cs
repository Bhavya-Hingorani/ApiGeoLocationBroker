namespace ApiBroker.Utils
{
    public static class Constants
    {
        ...
        public static readonly int MOCK_RATE_LIMIT_TIME_INTERVAL = 1;
        public static readonly int SERVICE_PROVIDER_COOLDOWN_TIME = 1;
        public static readonly float AVG_ERROR_RATE_HARD_THRESHOLD = 1f;
